...
pass:[<div class="module-buttons"><button class="solve-button" data-solve-script="solve-module-4">✅ Solve Module 4</button><button class="validate-button" data-validate-script="validate-module-4">🔍 Validate Module 4</button></div>]
