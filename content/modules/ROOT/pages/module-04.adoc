...
+
NOTE: For more details on configuring Quay Container Registry as a scanner integration, refer to the link:https://docs.redhat.com/en/documentation/red_hat_advanced_cluster_security_for_kubernetes/4.9/html/integrating/integrate-with-image-vulnerability-scanners#integrate-with-qcr-scanner_integrate-with-image-vulnerability-scanners[official Red Hat ACS documentation^].
...
pass:[<script type="text/plain" id="solve-module-4" style="display: none;">~/lab-assets/solve-module-4.sh</script>]

pass:[<script type="text/plain" id="validate-module-4" style="display: none;">~/lab-assets/validate-module-4.sh</script>]

pass:[<div style="text-align: center; margin: 1rem 0;"><button class="solve-button" data-solve-script="solve-module-4">✅ Solve Module 4</button> <button class="solve-button" data-validate-script="validate-module-4">🔍 Validate Module 4</button></div>]
