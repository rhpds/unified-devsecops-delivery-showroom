...
pass:[<div class="module-buttons"><button class="solve-button" data-solve-script="solve-module-4">✅ Solve</button><button class="validate-button" data-validate-script="validate-module-4">🔍 Validate</button></div>]
