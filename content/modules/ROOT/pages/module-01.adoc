...
pass:[<div style="text-align: center; margin: 1rem 0;"><button class="solve-button" data-solve-script="solve-module-1">✅ Solve Module 1</button> <button class="solve-button" data-validate-script="validate-module-1">🔍 Validate Module 1</button></div>]
