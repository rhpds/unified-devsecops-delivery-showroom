...
pass:[<div class="module-buttons"><button class="solve-button" data-solve-script="solve-module-1">✅ Solve</button><button class="validate-button" data-validate-script="validate-module-1">🔍 Validate</button></div>]
