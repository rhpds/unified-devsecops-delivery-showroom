...
pass:[<div class="module-buttons"><button class="solve-button" data-solve-script="solve-module-3">✅ Solve</button><button class="validate-button" data-validate-script="validate-module-3">🔍 Validate</button></div>]
