...
pass:[<script type="text/plain" id="solve-module-3" style="display: none;">~/lab-assets/solve-module-3.sh</script>]

pass:[<script type="text/plain" id="validate-module-3" style="display: none;">~/lab-assets/validate-module-3.sh</script>]

pass:[<div style="text-align: center; margin: 1rem 0;"><button class="solve-button" data-solve-script="solve-module-3">✅ Solve Module 3</button> <button class="solve-button" data-validate-script="validate-module-3">🔍 Validate Module 3</button></div>]
